...
//		String uuid = UUID.randomUUID().toString().replace("-", "");
		//设置激活链接
//		String url = "http://192.168.10.104:8080//examOnline/user_active.action?uuidcode="+user.getUuidcode();
		String content = "<h1>尊敬的客户，您本次修改密码的邮箱验证码是(数字内容):       "+user.getEmailcode()+"   </h1>";
